    ...
    await this.transporter.sendMail({
      ...
      html: `
        ...
        <table style="border-collapse:collapse;width:100%;max-width:600px">
          <tr><td style="padding:8px;font-weight:700;background:#f5f5f5">Name</td><td style="padding:8px">${payload.name}</td></tr>
          <tr><td style="padding:8px;font-weight:700;background:#f5f5f5">Email</td><td style="padding:8px">${payload.email}</td></tr>
          <tr><td style="padding:8px;font-weight:700;background:#f5f5f5">Subject</td><td style="padding:8px">${payload.subject}</td></tr>
        </table>
        <h3>Message</h3>
