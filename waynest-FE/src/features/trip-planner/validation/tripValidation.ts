 ...
 */
export const validateTripForm = (data: CreateTripPlannerDto): ValidationResult => {
 ...
 */
export const isBudgetTooLow = (budget: number, persons: number, days: number): boolean => {
 ...
 */
export const calculateMinimumBudget = (persons: number, days: number): number => {
 ...
 */
export const sanitizeTripData = (data: CreateTripPlannerDto): CreateTripPlannerDto => {
  return {
