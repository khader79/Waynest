...
import { loginWithCredentials } from "@/services/auth/auth.service";
import {
  resendEmailVerificationCode,
  verifyEmailCode,
} from "@/services/auth/emailVerification.service";
...
export const useEmailVerification = () => {
  ...
  useEffect(() => {
    const state = location.state as PendingCredentials | null;
    ...
    try {
      const parsed = JSON.parse(stored) as PendingCredentials;
